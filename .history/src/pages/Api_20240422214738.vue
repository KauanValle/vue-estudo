<template>
    <div class="container">
        ...
        <div>
           ...
           <div class="usuario" v-for="usuario in listaUsuarios" :key="usuario.nome">
                <p>Kauan Valle Santos</p>
                <p>kauanvalle3@gmail.com</p>
           </div>
...
export default {
    ...
    methods: {
        ...
        pegarUsuarios(){
            this.listaUsuarios = this.usuariosGetters
